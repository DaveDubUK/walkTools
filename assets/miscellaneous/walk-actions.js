...
actions = {
    ...
    "MaleProtectHeadRP": {
        ...
        duration: 0.8,
        reachPose: "MaleProtectHeadRP",
        delay: {timing:0, strength:0},
        attack: {timing:0.1, strength:1.0},
    ...
    "ComingInToLand": {
        ...
        duration: 0.25,
        reachPose: "ComingInToLand",
        delay: {timing:0, strength:0},
        attack: {timing:0.3, strength:1.0},
        decay: {timing:0.7, strength:1.0},
        sustain: {timing:0.7, strength:1.0},
        release: {timing:1, strength:0},
        smoothing: 10
    },
    ...
    "ShrugRP": {
        ...
        reachPose: "ShrugRP",
        delay: {timing:0, strength:0},
        attack: {timing:0.6, strength:1.0},
        decay: {timing:0.6, strength:1.0},
        sustain: {timing:0.6, strength:1.0},
        release: {timing:1.0, strength:0},
        smoothing: 50
    }
};