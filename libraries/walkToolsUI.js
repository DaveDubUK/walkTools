...
walkInterface = (function() {
    ...
    var _momentaryButtonDelay = 80; // mS
    ...
    var _controlsBackground = Overlays.addOverlay("image", {
        ...
        imageURL: pathToAssets + "walktools-overlay-images/walkTools-background.png", alpha: 1, visible: false
    });
    _backgroundOverlays.push(_controlsBackground);

    var _controlsBackgroundEditJoints = Overlays.addOverlay("image", {
        bounds: {x: _backgroundX, y: _backgroundY, width: _backgroundWidth, height: _backgroundHeight},
        imageURL: pathToAssets + "walktools-overlay-images/background-edit-joints.png",
    ...
    var _controlsBackgroundEditHipTrans = Overlays.addOverlay("image", {
        bounds: {x: _backgroundX, y: _backgroundY, width: _backgroundWidth, height: _backgroundHeight},
        imageURL: pathToAssets + "walktools-overlay-images/background-edit-translation.png",
        alpha: 1, visible: false
    });
    ...
    var _hipsJointsTranslation = Overlays.addOverlay("image", {
        ...
        imageURL: pathToAssets + "walktools-overlay-images/background-edit-hips-translation.png",
        alpha: 1, visible: false
    });
    ...
    var _hipsJointControl = Overlays.addOverlay("image", {
        bounds: {x: _jointsControlX, y: _jointsControlY, width: 200, height: 300},
        imageURL: pathToAssets + "walktools-overlay-images/ddao-background-edit-hips.png",
        alpha: 1, visible: false
    });
    ...
    var _leftUpperLegJointControl = Overlays.addOverlay("image", {
        bounds: {x: _jointsControlX, y: _jointsControlY, width: 200, height: 300},
        imageURL: pathToAssets + "walktools-overlay-images/ddao-background-edit-left-upper-leg.png",
        alpha: 1, visible: false
    });
    ...
    var _rightUpperLegJointControl = Overlays.addOverlay("image", {
        bounds: {x: _jointsControlX, y: _jointsControlY, width: 200, height: 300},
        imageURL: pathToAssets + "walktools-overlay-images/ddao-background-edit-right-upper-leg.png",
        alpha: 1, visible: false
    });
    ...
    var _leftLowerLegJointControl = Overlays.addOverlay("image", {
        bounds: {x: _jointsControlX, y: _jointsControlY, width: 200, height: 300},
        imageURL: pathToAssets + "walktools-overlay-images/ddao-background-edit-left-lower-leg.png",
        alpha: 1, visible: false
    });
    ...
    var _rightLowerLegJointControl = Overlays.addOverlay("image", {
        bounds: {x: _jointsControlX, y: _jointsControlY, width: 200, height: 300},
        imageURL: pathToAssets + "walktools-overlay-images/ddao-background-edit-right-lower-leg.png",
        alpha: 1, visible: false
    });
    ...
    var _leftFootJointControl = Overlays.addOverlay("image", {
        bounds: {x: _jointsControlX, y: _jointsControlY, width: 200, height: 300},
        imageURL: pathToAssets + "walktools-overlay-images/ddao-background-edit-left-foot.png",
        alpha: 1, visible: false
    });
    ...
    var _rightFootJointControl = Overlays.addOverlay("image", {
        bounds: {x: _jointsControlX, y: _jointsControlY, width: 200, height: 300},
        imageURL: pathToAssets + "walktools-overlay-images/ddao-background-edit-right-foot.png",
        alpha: 1, visible: false
    });
    ...
    var _leftToesJointControl = Overlays.addOverlay("image", {
        bounds: {x: _jointsControlX, y: _jointsControlY, width: 200, height: 300},
        imageURL: pathToAssets + "walktools-overlay-images/ddao-background-edit-left-toes.png",
        alpha: 1, visible: false
    });
    ...
    var _rightToesJointControl = Overlays.addOverlay("image", {
        bounds: {x: _jointsControlX, y: _jointsControlY, width: 200, height: 300},
        imageURL: pathToAssets + "walktools-overlay-images/ddao-background-edit-right-toes.png",
        alpha: 1, visible: false
    });
    ...
    var _spineJointControl = Overlays.addOverlay("image", {
        bounds: {x: _jointsControlX, y: _jointsControlY, width: 200, height: 300},
        imageURL: pathToAssets + "walktools-overlay-images/ddao-background-edit-spine.png",
        alpha: 1, visible: false
    });
    ...
    var _spine1JointControl = Overlays.addOverlay("image", {
        bounds: {x: _jointsControlX, y: _jointsControlY, width: 200, height: 300},
        imageURL: pathToAssets + "walktools-overlay-images/ddao-background-edit-spine1.png",
        alpha: 1, visible: false
    });
    ...
    var _spine2JointControl = Overlays.addOverlay("image", {
        bounds: {x: _jointsControlX, y: _jointsControlY, width: 200, height: 300},
        imageURL: pathToAssets + "walktools-overlay-images/ddao-background-edit-spine2.png",
        alpha: 1, visible: false
    });
    ...
    var _leftShoulderJointControl = Overlays.addOverlay("image", {
        bounds: {x: _jointsControlX, y: _jointsControlY, width: 200, height: 300},
        imageURL: pathToAssets + "walktools-overlay-images/ddao-background-edit-left-shoulder.png",
        alpha: 1, visible: false
    });
    ...
    var _rightShoulderJointControl = Overlays.addOverlay("image", {
        bounds: {x: _jointsControlX, y: _jointsControlY, width: 200, height: 300},
        imageURL: pathToAssets + "walktools-overlay-images/ddao-background-edit-right-shoulder.png",
        alpha: 1, visible: false
    });
    ...
    var _leftUpperArmJointControl = Overlays.addOverlay("image", {
        bounds: {x: _jointsControlX, y: _jointsControlY, width: 200, height: 300},
        imageURL: pathToAssets + "walktools-overlay-images/ddao-background-edit-left-upper-arm.png",
        alpha: 1, visible: false
    });
    ...
    var _rightUpperArmJointControl = Overlays.addOverlay("image", {
        bounds: {x: _jointsControlX, y: _jointsControlY, width: 200, height: 300},
        imageURL: pathToAssets + "walktools-overlay-images/ddao-background-edit-right-upper-arm.png",
        alpha: 1, visible: false
    });
    ...
    var _leftForeArmJointControl = Overlays.addOverlay("image", {
        bounds: {x: _jointsControlX, y: _jointsControlY, width: 200, height: 300},
        imageURL: pathToAssets + "walktools-overlay-images/ddao-background-edit-left-forearm.png",
        alpha: 1, visible: false
    });
    ...
    var _rightForeArmJointControl = Overlays.addOverlay("image", {
        bounds: {x: _jointsControlX, y: _jointsControlY, width: 200, height: 300},
        imageURL: pathToAssets + "walktools-overlay-images/ddao-background-edit-right-forearm.png",
        alpha: 1, visible: false
    });
    ...
    var _leftHandJointControl = Overlays.addOverlay("image", {
        bounds: {x: _jointsControlX, y: _jointsControlY, width: 200, height: 300},
        imageURL: pathToAssets + "walktools-overlay-images/ddao-background-edit-left-hand.png",
        alpha: 1, visible: false
    });
    ...
    var _rightHandJointControl = Overlays.addOverlay("image", {
        bounds: {x: _jointsControlX, y: _jointsControlY, width: 200, height: 300},
        imageURL: pathToAssets + "walktools-overlay-images/ddao-background-edit-right-hand.png",
        alpha: 1, visible: false
    });
    ...
    var _neckJointControl = Overlays.addOverlay("image", {
        bounds: {x: _jointsControlX, y: _jointsControlY, width: 200, height: 300},
        imageURL: pathToAssets + "walktools-overlay-images/ddao-background-edit-neck.png",
        alpha: 1, visible: false
    });
    ...
    var _headJointControl = Overlays.addOverlay("image", {
        bounds: {x: _jointsControlX, y: _jointsControlY, width: 200, height: 300},
        imageURL: pathToAssets + "walktools-overlay-images/ddao-background-edit-head.png",
        alpha: 1, visible: false
    });
    ...
    var _onButton = Overlays.addOverlay("image", {
        ...
        imageURL: pathToAssets + "walktools-overlay-images/walkTools-on-button.png",
        alpha: 1, visible: false
    });
    ...
    var _offButton = Overlays.addOverlay("image", {
        bounds: {x: _backgroundX + 20, y: _backgroundY + _buttonsY, width: 60, height: 47},
        imageURL: pathToAssets + "walktools-overlay-images/walkTools-off-button.png",
        alpha: 1, visible: false
    });
    ...
    var _editOppSymButton = Overlays.addOverlay("image", {
        ...
        imageURL: pathToAssets + "walktools-overlay-images/walkTools-edit-opp-sym-button.png",
        alpha: 1, visible: false
    });
    ...
    var _editOppSymButtonSelected = Overlays.addOverlay("image", {
        bounds: {x: _backgroundX + 83, y: _backgroundY + _buttonsY, width: 60, height: 47},
        imageURL: pathToAssets + "walktools-overlay-images/walkTools-edit-opp-sym-button-selected.png",
        alpha: 1, visible: false
    });
    ...
    var _editSymButton = Overlays.addOverlay("image", {
        ...
        imageURL: pathToAssets + "walktools-overlay-images/walkTools-edit-sym-button.png",
        alpha: 1, visible: false
    });
    ...
    var _editSymButtonSelected = Overlays.addOverlay("image", {
        bounds: {x: _backgroundX + 146, y: _backgroundY + _buttonsY, width: 60, height: 47},
        imageURL: pathToAssets + "walktools-overlay-images/walkTools-edit-sym-button-selected.png",
        alpha: 1, visible: false
    });
    ...
    var _editFreeButton = Overlays.addOverlay("image", {
        ...
        imageURL: pathToAssets + "walktools-overlay-images/walkTools-edit-free-button.png",
        alpha: 1, visible: false
    });
    ...
    var _editFreeButtonSelected = Overlays.addOverlay("image", {
        bounds: {x: _backgroundX + 209, y: _backgroundY + _buttonsY, width: 60, height: 47},
        imageURL: pathToAssets + "walktools-overlay-images/walkTools-edit-free-button-selected.png",
        alpha: 1, visible: false
    });
    ...
    var _animationSelectButton = Overlays.addOverlay("image", {
        ...
        imageURL: pathToAssets + "walktools-overlay-images/walkTools-animation-select-button.png",
        alpha: 1, visible: false
    });
    ...
    var _animationSelectButtonSelected = Overlays.addOverlay("image", {
        bounds: {x: _backgroundX + 272, y: _backgroundY + _buttonsY, width: 60, height: 47},
        imageURL: pathToAssets + "walktools-overlay-images/walkTools-animation-select-button-selected.png",
        alpha: 1, visible: false
    });
    ...
    var _characterButton = Overlays.addOverlay("image", {
        ...
        imageURL: pathToAssets + "walktools-overlay-images/ddpa-character-button.png",
        alpha: 1, visible: false
    });
    ...
    var _characterButtonSelected = Overlays.addOverlay("image", {
        bounds: {x: _backgroundX + _backgroundWidth / 2 - 115, y: _backgroundY + _bigButtonsY + 60, width: 230, height: 36},
        imageURL: pathToAssets + "walktools-overlay-images/ddpa-character-button-selected.png",
        alpha: 1, visible: false
    });
    ...
    var _armsFreeBigButton = Overlays.addOverlay("image", {
        ...
        imageURL: pathToAssets + "walktools-overlay-images/ddpa-arms-free-button.png",
        alpha: 1, visible: false
    });
    ...
    var _armsFreeBigButtonSelected = Overlays.addOverlay("image", {
        bounds: {x: _backgroundX + _backgroundWidth / 2 - 115, y: _backgroundY + _bigButtonsY + 120, width: 230, height: 36},
        imageURL: pathToAssets + "walktools-overlay-images/ddpa-arms-free-button-selected.png",
        alpha: 1, visible: false
    });
    ...
    var _footstepsBigButton = Overlays.addOverlay("image", {
        ...
        imageURL: pathToAssets + "walktools-overlay-images/ddpa-footstep-sounds-button.png",
        alpha: 1, visible: false
    });
    ...
    var _footstepsBigButtonSelected = Overlays.addOverlay("image", {
        bounds: {x: _backgroundX + _backgroundWidth / 2 - 115, y: _backgroundY + _bigButtonsY + 180, width: 230, height: 36},
        imageURL: pathToAssets + "walktools-overlay-images/ddpa-footstep-sounds-button-selected.png",
        alpha: 1, visible: false
    });
    ...
    function updateJointSelector() {
        ...
        if (walkTools.editingTranslation) {
            ...
            // Hips sway
            var sliderXPos = avatar.currentAnimation.joints["Hips"].sway / _sliderRanges["Hips"].swayRange * _sliderRangeX;
            ...
            // Hips bob
            sliderXPos = avatar.currentAnimation.joints["Hips"].bob / _sliderRanges["Hips"].bobRange * _sliderRangeX;
            Overlays.editOverlay(_sliderThumbOverlays[++i], {
                x: _minSliderX + sliderXPos,
                y: yLocation += 30,
                visible: true
            ...
            // Hips thrust
            sliderXPos = avatar.currentAnimation.joints["Hips"].thrust / _sliderRanges["Hips"].thrustRange * _sliderRangeX;
            Overlays.editOverlay(_sliderThumbOverlays[++i], {
                x: _minSliderX + sliderXPos,
                y: yLocation += 30,
                visible: true
            ...
            // Sway Phase
            sliderXPos = (90 + avatar.currentAnimation.joints["Hips"].swayPhase / 2) / 180 * _sliderRangeX;
            Overlays.editOverlay(_sliderThumbOverlays[++i], {
                x: _minSliderX + sliderXPos,
                y: yLocation += 30,
                visible: true
            ...
            // Bob Phase
            sliderXPos = (90 + avatar.currentAnimation.joints["Hips"].bobPhase / 2) / 180 * _sliderRangeX;
            Overlays.editOverlay(_sliderThumbOverlays[++i], {
                x: _minSliderX + sliderXPos,
                y: yLocation += 30,
                visible: true
            ...
            // Thrust Phase
            sliderXPos = (90 + avatar.currentAnimation.joints["Hips"].thrustPhase / 2) / 180 * _sliderRangeX;
            Overlays.editOverlay(_sliderThumbOverlays[++i], {
                x: _minSliderX + sliderXPos,
                y: yLocation += 30,
                visible: true
            ...
            sliderXPos = (((_sliderRanges["Hips"].swayOffsetRange + avatar.currentAnimation.joints["Hips"]
            ...
            sliderXPos = (((_sliderRanges["Hips"].bobOffsetRange + avatar.currentAnimation.joints["Hips"]
            ...
            sliderXPos = (((_sliderRanges["Hips"].thrustOffsetRange + avatar.currentAnimation.joints["Hips"]
            ...
            sliderXPos =
                (90 + avatar.currentAnimation.joints[walkTools.selectedJoint()].pitchPhase / 2) / 180 * _sliderRangeX;
            Overlays.editOverlay(_sliderThumbOverlays[++i], {x: _minSliderX + sliderXPos, y: yLocation += 30, visible: true});

            sliderXPos =
                (90 + avatar.currentAnimation.joints[walkTools.selectedJoint()].yawPhase / 2) / 180 * _sliderRangeX;
            Overlays.editOverlay(_sliderThumbOverlays[++i], {x: _minSliderX + sliderXPos, y: yLocation += 30, visible: true});

            sliderXPos =
                (90 + avatar.currentAnimation.joints[walkTools.selectedJoint()].rollPhase / 2) / 180 * _sliderRangeX;
            Overlays.editOverlay(_sliderThumbOverlays[++i], {x: _minSliderX + sliderXPos, y: yLocation += 30, visible: true});
    ...
    return {
        ...
        initialise: function(walkAssets, avatar, motion) {
            motion = motion;
            walkAssets = walkAssets;
            avatar = avatar;
        },
